...
replacements = {
    'STAMP = "20260715T174533KST"': 'STAMP = "20260715T224000KST"',
    'STAMP_LOWER = "20260715t174533"': 'STAMP_LOWER = "20260715t224000"',
    ...
    'max_workers = min(5, max(1, len(batches)))': 'max_workers = min(20, max(1, len(batches)))',
}
