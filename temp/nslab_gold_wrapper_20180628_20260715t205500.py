...
# Reuse only the compile-verified runner source code. Every research input is
# freshly acquired from current-main Raw URLs inside this clean Actions run.
runner = Path("parallel_source/temp/nslab_parallel_runner_20220826_20260715t171800.py")
text = runner.read_text(encoding="utf-8")

replacements = [
    ("20260715T171800KST", "20260715T205500KST"),
    ("20260715t171800", "20260715t205500"),
    ("20220826", "20180628"),
    ("20220825", "20180627"),
...
namespace = {
    "__name__": "nslab_gold_runner_20180628_20260715t205500",
    "__file__": str(runner),
}
...
def current_prepare() -> dict:
    ...
    # The parser remains a clerk. Full title/body adjudication is performed by
    # independent semantic model calls, with one returned record per source row.
