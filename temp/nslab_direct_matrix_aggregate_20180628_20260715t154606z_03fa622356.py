...
request = urllib.request.Request(
    ...
    headers={
        ...
        "User-Agent": "NSLAB-DIRECT-20180628-20260715T154606Z-03FA622356-AGGREGATE",
...
replacements = [
    ...
    ("20260715t222908", "20260715t154606z"),
]
for old, new in replacements:
    if old not in source:
        raise RuntimeError(f"direct aggregate patch anchor missing: {old}")
