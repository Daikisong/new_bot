...
text = text.replace("20260715T171800KST", "20260715T182800KST")
text = text.replace("20260715t171800", "20260715t182800")
...
new_workers = 'ThreadPoolExecutor(max_workers=16, thread_name_prefix="nslab-semantic")'
assert old_workers in text
text = text.replace(old_workers, new_workers, 1)

namespace = {"__name__": "nslab_compact_runner", "__file__": str(runner)}
