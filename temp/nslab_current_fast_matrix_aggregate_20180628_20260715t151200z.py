...
request = urllib.request.Request(
    ...
    headers={
        ...
        "User-Agent": "NSLAB-CURRENT-FAST-20180628-20260715T151200Z-AGGREGATE",
...
replacements = [
    ("20260715T222908KST", "20260715T151200Z"),
    ("20260715t222908", "20260715t151200z"),
]
for old, new in replacements:
    if old not in source:
        raise RuntimeError(f"fast aggregate patch anchor missing: {old}")
