...
EXPECTED_SCHEMA_FILES = {
    ...
    "brain_package_manifest.schema.json",
    "brain_package_pointer.schema.json",
    ...
    "current_event_capsule.schema.json",
    "daily_brain_context_v2.schema.json",
    ...
    "offline_compile_manifest.schema.json",
    ...
    "runtime_evidence_memo.schema.json",
    "runtime_evidence_memo_batch.schema.json",
    "runtime_evidence_memo_pack.schema.json",
    "runtime_evidence_pack_manifest.schema.json",
    "runtime_evidence_pack_plan.schema.json",
    "runtime_retrieval_trace.schema.json",
    "semantic_retrieval_plan.schema.json",
    "semantic_influence_manifest.schema.json",
    "semantic_memory_capsule.schema.json",
